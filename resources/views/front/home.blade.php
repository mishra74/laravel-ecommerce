    ...
    <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="3000">
        <div class="carousel-inner">
            <div class="carousel-item ">
                ...
                <picture>
                    <source media="(max-width: 799px)" srcset="{{ asset('front-assets/images/2.png') }}" />
                    <source media="(min-width: 800px)" srcset="{{ asset('front-assets/images/2.png') }}" />
                    <img src="{{ asset('front-assets/images/carousel-1.jpg') }}" alt="" />
                </picture>

                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3">
                        <h1 class="display-4 text-white mb-3">Women Fashion</h1>
                        <p class="mx-md-5 px-5">Shop Online at Flat 70% off on Branded Clothes</p>
            ...
            <div class="carousel-item">
               ...
               <picture>
                    <source media="(max-width: 799px)" srcset="{{ asset('front-assets/images/1.png') }}" />
                    <source media="(min-width: 800px)" srcset="{{ asset('front-assets/images/1.png') }}" />
                    <img src="{{ asset('front-assets/images/1.png') }}" alt="" />
                </picture>
            ...
            <div class="carousel-item active">
                ...
                <picture>
                  <source media="(max-width: 799px)" srcset="{{ asset('/front-assets/images/2.png') }}" />
                  <source media="(max-width: 799px)" srcset="{{ asset('/front-assets/images/.png') }}" />
