                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input size-toggle" type="checkbox" id="size_{{ $sizeOption }}" name="size_enabled[]" value="{{ $sizeOption }}" {{ isset($productSizes[$sizeOption]) ? 'checked' : '' }}>
                                                <label for="size_{{ $sizeOption }}" class="custom-control-label">{{ $sizeOption }}</label>
                                            </div>
                                            <input type="number" min="0" class="form-control mt-2" name="size_qty[{{ $sizeOption }}]" id="size_qty_{{ $sizeOption }}" placeholder="Qty" value="{{ $productSizes[$sizeOption]->qty ?? '' }}" {{ isset($productSizes[$sizeOption]) ? '' : 'disabled' }}>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
