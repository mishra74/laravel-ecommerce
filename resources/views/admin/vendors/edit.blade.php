    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('admin.vendors.index') }}" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="container-fluid">
        <form action="" method="post" id="vendorForm" name="vendorForm">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="status" id="status" class="form-control">
                                    ...
                                    <option {{ ($vendor->status == 0) ? 'selected' : ''  }} value="0">Suspended</option>
                                </select>
                                <p></p>
                            </div>
                        </div>
            ...
            <div class="pb-5 pt-3">
                ...
                <a href="{{ route('admin.vendors.index') }}" class="btn btn-outline-dark ml-3">Cancel</a>
            </div>
        </form>
    </div>
    <!-- /.card -->
